...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Track trending games, top studios, active player counts and live rankings across the gaming universe." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Gamestats — Live Gaming Analytics" },
      { name: "twitter:description", content: "Track trending games, top studios, active player counts and live rankings across the gaming universe." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/bfb24723-5af0-4a67-971d-21517cbaefa9" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/bfb24723-5af0-4a67-971d-21517cbaefa9" },
    ],
    links: [

  ...
  return (
    <footer className="mt-20 border-t border-border/50">
      <div className="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
        <div>
          <span className="font-display font-bold tracking-wider text-foreground">GAMESTATS</span> — gaming analytics, live.
        </div>
        ...
        <div className="text-xs">© {new Date().getFullYear()} Gamestats</div>
      </div>
    </footer>
  );
}
